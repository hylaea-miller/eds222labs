...
storm_data <- read_csv(here("week_2", "data", "la_storm.csv"))
...
Beta_0: estimated gage height when no precipitation

Beta_1: for every inch of rain, the increase in gage height

Sigma (SD): how much do we espect to be wrong
...
# What fraction of the variance in gage gege height have we explain using precipitation
R2 <- (SST - SSE) / SST
...
# mod_summ$coefficients[1,1] = intercept
# mod_summ$coefficients[2,1] = S
```
